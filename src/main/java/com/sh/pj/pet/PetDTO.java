...
public int getPs_notice() {
	return ps_notice;
}

public void setPs_notice(int ps_notice) {
...
public String toString() {
	return "PetDTO [ps_id=" + ps_id + ", ps_file=" + ps_file + ", ps_Rfile=" + ps_Rfile + ", ps_confirm=" + ps_confirm
			+ ", ps_confirm_answer=" + ps_confirm_answer + ", ps_cctv=" + ps_cctv + ", ps_term=" + ps_term + ", ps_day="
			+ ps_day + ", ps_hour=" + ps_hour + ", ps_location1=" + ps_location1 + ", ps_location2=" + ps_location2
			+ ", ps_location3=" + ps_location3 + ", ps_extra=" + ps_extra + ", ps_exp=" + ps_exp + ", ps_pay=" + ps_pay
			+ ", ps_point=" + ps_point + ", ps_count=" + ps_count + ", ps_can_do=" + ps_can_do + ", ps_can_type="
			+ ps_can_type + ", ps_ticket_start=" + ps_ticket_start + ", ps_ticket_end=" + ps_ticket_end
			+ ", ps_write_date=" + ps_write_date + ", ps_notice=" + ps_notice + ", ps_type=" + Arrays.toString(ps_type)
			+ ", petsitter_act=" + Arrays.toString(petsitter_act) + ", monday=" + monday + ", tuesday=" + tuesday
			+ ", wednesday=" + wednesday + ", thursday=" + thursday + ", friday=" + friday + ", saturday=" + saturday
			+ ", sunday=" + sunday + ", monday_start=" + monday_start + ", tuesday_start=" + tuesday_start
			+ ", wednesday_start=" + wednesday_start + ", thursday_start=" + thursday_start + ", friday_start="
			+ friday_start + ", saturday_start=" + saturday_start + ", sunday_start=" + sunday_start + ", monday_end="
			+ monday_end + ", tuesday_end=" + tuesday_end + ", wednesday_end=" + wednesday_end + ", thursday_end="
			+ thursday_end + ", friday_end=" + friday_end + ", saturday_end=" + saturday_end + ", sunday_end="
			+ sunday_end + "]";
}
...
public PetDTO(String ps_id, String ps_file, MultipartFile ps_Rfile, String ps_confirm, String ps_confirm_answer,
		...
		String ps_location3, String ps_extra, String ps_exp, int ps_pay, int ps_point, int ps_count, String ps_can_do,
		String ps_can_type, Date ps_ticket_start, Date ps_ticket_end, Date ps_write_date, int ps_notice, int[] ps_type,
		int[] petsitter_act, String monday, String tuesday, String wednesday, String thursday, String friday,
		String saturday, String sunday, int monday_start, int tuesday_start, int wednesday_start, int thursday_start,
		int friday_start, int saturday_start, int sunday_start, int monday_end, int tuesday_end, int wednesday_end,
		int thursday_end, int friday_end, int saturday_end, int sunday_end) {
	super();
	this.ps_id = ps_id;
	this.ps_file = ps_file;
	this.ps_Rfile = ps_Rfile;
