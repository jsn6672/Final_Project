...
public class AskDTO {
	 ...
	 private String inquiry_encodingbody;
	...
	public String getInquiry_encodingbody() {
		return inquiry_encodingbody;
	}


	public void setInquiry_encodingbody(String inquiry_encodingbody) {
		this.inquiry_encodingbody = inquiry_encodingbody;
	}
	...
	public String toString() {
		return "AskDTO [inquiry_no=" + inquiry_no + ", inquiry_id=" + inquiry_id + ", inquiry_title=" + inquiry_title
				...
				+ ", inquiry_type=" + inquiry_type + ", keyword=" + keyword + ", inquiry_encodingbody="
				+ inquiry_encodingbody + "]";
	}
	...
	public AskDTO(int inquiry_no, String inquiry_id, String inquiry_title, String inquiry_body,
			...
			String keyword, String inquiry_encodingbody) {
		super();
		this.inquiry_no = inquiry_no;
		this.inquiry_id = inquiry_id;
		this.inquiry_title = inquiry_title;
