...
public class CareDTO {
	...
	public String toString() {
		return "CareDTO [cs_id=" + cs_id + ", cs_file=" + cs_file + ", cs_Rfile=" + cs_Rfile + ", cs_confirm="
				...
				+ ", cs_can_do=" + cs_can_do + ", cs_can_type=" + cs_can_type + ", cs_notice=" + cs_notice
				+ ", cs_ticket_start=" + cs_ticket_start + ", cs_ticket_end=" + cs_ticket_end + ", cs_write_date="
				+ cs_write_date + ", cs_type=" + Arrays.toString(cs_type) + ", caresitter_act="
				+ Arrays.toString(caresitter_act) + ", monday=" + monday + ", tuesday=" + tuesday + ", wednesday="
	...
	public CareDTO(String cs_id, String cs_file, MultipartFile cs_Rfile, String cs_confirm, String cs_confirm_answer,
			String cs_cctv, String cs_term, String cs_day, String cs_hour, String cs_location1, String cs_location2,
			String cs_location3, String cs_extra, String cs_exp, int cs_pay, int cs_point, int cs_count,
			String cs_can_do, String cs_can_type, String cs_notice, Date cs_ticket_start, Date cs_ticket_end,
			Date cs_write_date, int[] cs_type, int[] caresitter_act, String monday, String tuesday, String wednesday,
