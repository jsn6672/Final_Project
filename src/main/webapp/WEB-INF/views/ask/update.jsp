				...
				<div class="QnA-body">
					...
					<div class="QnA-list-titles">
						...
						<div class="QnA-list-titles">
							...
							<div class="QnA-list-title2">
							<div><input name="inquiry_title" placeholder="${s.inquiry_title }" style="border: none"></div>
							</div>
						</div>
						<div class="QnA-list-titles">
							<div class="QnA-list-title1">내용</div>
							<div class="QnA-list-title2">
							<div><input name="inquiry_body" placeholder="${s.inquiry_body }" style="border: none"></div>
							</div>
						</div>
