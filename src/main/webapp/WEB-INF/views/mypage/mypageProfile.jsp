...
<body>
	...
	<!-- 프로필 수정의 전체 컨테이너 -->
	<div class="mpP">
		<form action="mypage.profile.do" method="post" enctype="multipart/form-data">
			<!-- 내용 부분 컨테이너 -->
			<div class="mpPDetailContainer">
				...
				<div class="mpPProfile">
					...
					<div class="mpP-info">
						...
						<div class="mpPAddr">
							주소 <br> <input id="jm_addr3Input" readonly="readonly" name="m_addr3"
							class="normal_input" maxlength="5" autocomplete="off"
							style="width: 620px;" placeholder="우편번호" value="${memberProfile.m_addr3 }"> <span
							id="addrSearchBtn">[검색]</span><br> <br> <input
							id="jm_addr1Input" readonly="readonly" name="m_addr1"
							maxlength="30" autocomplete="off" placeholder="주소" value="${memberProfile.m_addr1 }"
							class="normal_input"><br> <br> <input
							name="m_addr2" maxlength="30" autocomplete="off"
							class="normal_input" placeholder="상세주소" id="jm_addr2Input" value="${memberProfile.m_addr2 }">
						</div>
						<div class="mpPAddr">
							<div>
								연락처 <br>
