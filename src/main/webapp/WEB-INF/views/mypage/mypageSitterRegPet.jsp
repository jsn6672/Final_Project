	...
	<form action="mypage.sitterRegPet.do" method="post" enctype="multipart/form-data">
		...
		<div class="mpS-pet">
			...
			<div class="mpS-pet-sub">
				...
				<div> <input placeholder="아이가 태어난 해를 입력해주세요 (YYYY)" class="birth_input"> 
					<input placeholder="아이가 태어난 달을 입력해주세요" class="birth_input">
				</div>
				<div class="mpS-pet-gender">
					<input type="radio" name="mpSPetGender" value="male">남아 <input
						type="radio" name="mpSPetGender" value="female">여아 <input
						type="radio" name="mpSPetGender" value="neut">중성화 완료
				</div>
				<div>
					<input type="checkbox"> 알러지 또는 주의할 점이 있어요!
				</div>
				<div>
					<textarea rows="10" cols="50" placeholder="추가사항이 있다면 이곳에 적어주세요!"></textarea>
				</div>
			</div>
