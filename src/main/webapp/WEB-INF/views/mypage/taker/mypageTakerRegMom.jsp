	...
	<form action="momtaker.be" method="post" enctype="multipart/form-data">
		...
		<div class="mpS-pet">
			...
			<div class="mpS-pet-sub">
				...
				<div>
					<input type="file" name="mt_Rfile"  style="background-color: #D9D9D9; color: black; border: none; border-radius: 5px; padding: 5px; width: 225px;">
				</div>
				...
				<button style="margin: 20px;  width: 120px;">등록 완료</button>
			</div>
