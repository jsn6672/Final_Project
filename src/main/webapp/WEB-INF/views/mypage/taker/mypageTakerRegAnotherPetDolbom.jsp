...
<html>
  ...
  <body>
    <div class="mpS-pet-2">
      <c:forEach items="${DolbomList }" var="s">
        <div class="body-content-another">
          <div>
            <span
              onclick="location.href='mypage.takerUpdateAnotherPetDolbom.go?d_no=${s.d_no}'"
              >유저명: ${s.d_name }</span
            >
          </div>
          <div>
    ...
    <div class="mpS-pet-3">
      <div>
        <form
          action="pettaker.update"
          method="post"
          enctype="multipart/form-data"
          onsubmit="return validateForm()"
        >
          <div class="mpS-pet-4" style="height: 200px">
            등록된 서류를 수정하고 싶으시면 파일을 입력 후 수정해주세요
            <input type="file" name="pt_Rfile" id="pt_Rfile" />
            <button>수정</button>
          </div>
        </form>
        <div class="mpS-pet-4">
