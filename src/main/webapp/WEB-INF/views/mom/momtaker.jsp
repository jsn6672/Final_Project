...
<body>
	<main id="main">
		<section style="background-color: #FFF5B8;padding-bottom: 30px;  height: 46vw;">
			<div class="container">
				<div class="row">
											...
											<div class="d-md-flex post-entry-2 half"
												...
												<div style="display: flex; gap: 30px;">
													<div>
														...
														<a href="momtaker.detail.go?d_no=${d.d_no }">대상:
															${d.d_name }</a>
														</div>	
														<div>
														<div>
										...
										<div class="col text-center">
											<div class="text-start py-4"
												...
												<div class="custom-pagination">
													<c:if test="${curPage != 1 }">
														<a
															href="page.change4?p=${curPage - 1}&ms_search=${searchSession.ms_search}"
													...
													<c:forEach begin="${startPage}" end="${endPage}"
														...
														<c:choose>
															<c:when test="${curPage == loop.index}">
																<a
																	href="page.change4?p=${loop.index}&ms_search=${searchSession.ms_search}"
																	class="active">${loop.index}</a>
															</c:when>
															<c:otherwise>
																<a
																	href="page.change4?p=${loop.index}&ms_search=${searchSession.ms_search}">${loop.index}</a>
															</c:otherwise>
														</c:choose>
													</c:forEach>
									...
									<div class="tab-pane fade show active" id="pills-popular"
										...
										<div class="post-entry-1 border-bottom">
											...
											<span class="author mb-3 d-block"> <a
												href="momtaker.detail.go?d_no=${d.d_no }">대상:
