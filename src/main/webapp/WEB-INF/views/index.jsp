			...
			<div class="row g-5">
				...
				<div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
					<div class="section-title">
						...
						<h1 class="display-6">모두의 시터는 말 그대로 모두를 위한 시터를 제공하겠다는 저희의 다짐을
							보여주는 말입니다</h1>
					</div>
		...
		<div class="container py-5">
			...
			<div class="owl-carousel product-carousel wow fadeInUp"
				...
				<a href="" class="d-block product-item rounded"> <img
					...
					src="resources/img/product-3.jpg" alt="">
					<div
						class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
					...
					src="resources/img/product-4.jpg" alt="">
					<div
						class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
			...
			<div class="row g-0">
				<div class="col-lg-6 py-5 wow fadeIn" data-wow-delay="0.1s">
					<div class="py-5">
						<h1 class="display-6 mb-4">
							당신이 위급할때는 <span class="text-white">CPR</span> 과 <span
								class="text-white">구급법</span>
						</h1>
						<h5 class="fw-normal lh-base fst-italic text-white mb-5">
							동영상을 보고 따라하세요. 위급할때는 당신이 구급대원입니다.</h5>
						<div class="row g-4 mb-5">
							<div class="col-sm-6">
								<div class="d-flex align-items-center">
									...
									<span class="text-dark">상황확인</span>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="d-flex align-items-center">
									...
									<span class="text-dark">119신고</span>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="d-flex align-items-center">
									...
									<span class="text-dark">기도확보</span>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="d-flex align-items-center">
									...
									<span class="text-dark">가슴압박</span>
								</div>
							</div>
						</div>
						<a class="btn btn-light rounded-pill py-3 px-5" href=""></a>
					</div>
				</div>
				<div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
					<div class="h-100 d-flex align-items-center justify-content-center"
						...
						<button type="button" class="btn-play" data-bs-toggle="modal"
							data-src="https://www.youtube.com/embed/pLvFWLCwn6M"
				...
				<!--  	<div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
					<div class="h-100 d-flex align-items-center justify-content-center"
						style="min-height: 300px;">
						<button type="button" class="btn-play" data-bs-toggle="modal"
							data-src="https://www.youtube.com/embed/CzSy0qELgWM"
							data-bs-target="#videoModal">
							<span>반려견 / 어린아이</span>
						</button>
					</div>
	...
	<div class="container-xxl py-5">
		<div class="container">
			<div class="section-title text-center mx-auto wow fadeInUp"
				...
				<h1 class="display-6">치매에 좋은 음식</h1>
			</div>
			<div class="row g-4">
				<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
					<div class="store-item position-relative text-center">
						<img class="img-fluid" src="resources/img/store-product-1.jpg"
							alt="">
						<div class="p-4">
							...
							<h4 class="mb-3">등푸른 생선</h4>
							<p>등푸른 생선은 비타민 E(토코페롤)가 풍부해 치매 예방에 도움이 되요^^</p>
							<h4 class="text-primary">$19.00</h4>
						</div>
						<div class="store-overlay">
							<a href="" class="btn btn-primary rounded-pill py-2 px-4 m-2">More
								Detail <i class="fa fa-arrow-right ms-2"></i>
							</a> <a href="" class="btn btn-dark rounded-pill py-2 px-4 m-2">Add
								to Cart <i class="fa fa-cart-plus ms-2"></i>
							</a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
					<div class="store-item position-relative text-center">
						<img class="img-fluid" src="resources/img/store-product-2.jpg"
							alt="">
						<div class="p-4">
							<div class="text-center mb-3">
								<small class="fa fa-star text-primary"></small> <small
							...
							<p>Aliqu diam amet diam et eos. Clita erat ipsum lorem erat
								ipsum lorem sit sed</p>
							<h4 class="text-primary">$19.00</h4>
						</div>
						<div class="store-overlay">
							<a href="" class="btn btn-primary rounded-pill py-2 px-4 m-2">More
				...
				<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
					<div class="store-item position-relative text-center">
						<img class="img-fluid" src="resources/img/store-product-3.jpg"
							alt="">
						<div class="p-4">
							<div class="text-center mb-3">
								<small class="fa fa-star text-primary"></small> <small
				...
				<div class="col-12 text-center wow fadeInUp" data-wow-delay="0.1s">
					<a href="" class="btn btn-primary rounded-pill py-3 px-5">View
						More Products</a>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-8">
					...
					<div class="row g-5">
						<div class="col-md-4 text-center wow fadeInUp"
							...
							<p class="mb-2">sky66722@naver.com</p>
							<p class="mb-0">lhgsky100@naver.com</p>
						</div>
						<div class="col-md-4 text-center wow fadeInUp"
							data-wow-delay="0.4s">
							<div class="btn-square mx-auto mb-3">
						...
						<div class="col-md-4 text-center wow fadeInUp"
							...
							<p class="mb-2">코아빌딩 8층 802호</p>
							<p class="mb-0">종각역 젊음의 거리</p>
						</div>
					</div>
				</div>
			</div>
